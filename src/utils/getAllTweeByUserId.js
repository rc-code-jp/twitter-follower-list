 ...
 * @returns 
 */
module.exports.getAllTweeByUserId = async (twitterApiClient, userId) => {
  let nextToken = undefined;
  const list = [];

  while(true) {
    const res = await getTweets(twitterApiClient, userId, nextToken);
...
const getTweets = async (twitterApiClient, userId, nextToken) => {
